...
ENV NEXT_PUBLIC_BETTER_AUTH_URL=$NEXT_PUBLIC_BETTER_AUTH_URL \
    FLEET_AGENT_BUCKET_NAME=$FLEET_AGENT_BUCKET_NAME \
...
# Build the app using Turborepo to ensure dependent packages are built first
RUN SKIP_ENV_VALIDATION=true bunx turbo build --filter=@trycompai/app
...
# Build the portal using Turborepo to ensure dependent packages are built first
RUN SKIP_ENV_VALIDATION=true bunx turbo build --filter=@trycompai/portal
